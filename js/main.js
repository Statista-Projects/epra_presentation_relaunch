...
$(window).load(function () {
	...
	//TweenMax.killAll();
	// TweenMax.killTweensOf( document.getElementById("landing_page"));
...
var mainScene = new ScrollMagic.Scene({ triggerElement:this.children[0] })
...
var svgDoc = a.contentDocument;
		...
		TweenMax.set([land_btn_1,land_btn_2,land_btn_3,land_btn_4,land_btn_5,land_btn_6,land_btn_7,land_btn_8], { autoAlpha:0});
		...
		function artworkAni(){
			...
			var tl = new TimelineMax();
					tl.staggerFrom([art,a2,a3,a4,a5,a1], 2, {autoAlpha:0, transformOrigin:"50% 50%", ease:Power1.easeInOut}, 0.5,"-=0.05");
					return tl;
...
function pathAni(path,start_dot,end_dot,item1,item2,xoff,yoff,btn){
	...
	var p1_2 = svgDoc.getElementById(item2);
		...
		var tl = new TimelineMax();
		var bezierData = MorphSVGPlugin.pathDataToBezier(svg_path,{align:dot, offsetX:xoff, offsetY:yoff});
		tl.set(dot, {autoAlpha:0,xPercent:-50, yPercent:-80});

		tl.from(startdot, 0.4, {autoAlpha:0,scale:0, ease:Power1.easeInOut})
		tl.set(dot, {autoAlpha:1})
		tl.from(svg_path, 2, { drawSVG: 0, ease: Linear.easeNone })

			.to(dot, 2, {bezier: {values:bezierData, type:"cubic", autoRotate:90}, ease:Linear.easeNone},"-=2.05")
			.set(btn, {autoAlpha:1})
			.staggerFrom([p1_1,p1_2], 2, {autoAlpha:0, transformOrigin:"50% 50%", ease:Power1.easeInOut}, 0.5,"-=0.05");
...
var overlap= "-=1.8"
		...
		master.add ("all")
					...
					.add(artworkAni())
					.add (pathAni("p1","p1_dot_start","p1_dot_end","land_slide_1_1","land_slide_1_2",0,15,land_btn_1))
					.add (pathAni("p2","p2_dot_start","p2_dot_end","land_slide_2_1","land_slide_2_2",0,15,land_btn_2),overlap)
					.add (pathAni("p3","p3_dot_start","p3_dot_end","land_slide_3_1","land_slide_3_2",0,15,land_btn_3),overlap)
					.add (pathAni("p4","p4_dot_start","p4_dot_end","land_slide_4_1","land_slide_4_2",0,15,land_btn_4),overlap)
					.add ("leftside")
					.add (pathAni("p5","p5_dot_start","p5_dot_end","land_slide_5_1","land_slide_5_2",0,5,land_btn_5),overlap)
					.add (pathAni("p6","p6_dot_start","p6_dot_end","land_slide_6_1","land_slide_6_2",6,2.5,land_btn_6),overlap)
					.add (pathAni("p7","p7_dot_start","p7_dot_end","land_slide_7_1","land_slide_7_2",10,4,land_btn_7),overlap)
					.add (pathAni("p8","p8_dot_start","p8_dot_end","land_slide_8_1","land_slide_8_2",12,4,land_btn_8),overlap)
			...
			//	master.play("all");
				...
				// add behaviour
									...
									land_btn_1.addEventListener("mousedown",function(){	TweenMax.to(window, 2, {scrollTo:"#project01",ease:Power1.easeInOut});	}, false);
							  	land_btn_2.addEventListener("mousedown",function(){	TweenMax.to(window, 2, {scrollTo:"#project02",ease:Power1.easeInOut});	}, false);
									land_btn_3.addEventListener("mousedown",function(){	TweenMax.to(window, 2, {scrollTo:"#project03",ease:Power1.easeInOut});	}, false);
									land_btn_4.addEventListener("mousedown",function(){	TweenMax.to(window, 2, {scrollTo:"#project04",ease:Power1.easeInOut});	}, false);
									land_btn_5.addEventListener("mousedown",function(){	TweenMax.to(window, 2, {scrollTo:"#project05",ease:Power1.easeInOut});	}, false);
									land_btn_6.addEventListener("mousedown",function(){	TweenMax.to(window, 2, {scrollTo:"#project06",ease:Power1.easeInOut});	}, false);
									land_btn_7.addEventListener("mousedown",function(){	TweenMax.to(window, 2, {scrollTo:"#project07",ease:Power1.easeInOut});	}, false);
									land_btn_8.addEventListener("mousedown",function(){	TweenMax.to(window, 2, {scrollTo:"#project08",ease:Power1.easeInOut});	}, false);


/* --------------------------SHOW NAVI------------------------------*/

var showNavi = new ScrollMagic.Scene({triggerElement: '#intro', 	triggerHook: "onEnter", offset: -500})
							.addTo(controller)
...
var s1_svg_obj = document.getElementById("s1img");
		...
		var s1tl = new TimelineMax();
				s1tl.staggerFrom([b5,b1,b2,b3,b4], 2, { y:550, transformOrigin:"50% 50%", ease:Power1.easeInOut}, 0.5,"-=0.05");
				return s1tl;
	}
...
var slide_1_AniScene = new ScrollMagic.Scene({triggerElement: '.s1_right_Content', 	triggerHook: 0.8})
//.addIndicators({name:'slide_1_AniScene',indent:400,	colorTrigger:'pink',	colorStart: 'red',	colorEnd: 'green' })
.on('start', function() { 	s1_master.play(0)})
.addTo(controller);
...
var s3tl = new TimelineMax();
		s3tl.add("in_1")
				...
				.add("in_2")
				.to(bull1, 2.8, {x:"-=30", ease:Bounce.easeOut,yoyo:true,repeat:5,repeatDelay:1.5},"in_2")
				.to(bull2, 2.8, {x:"+=30", ease:Bounce.easeOut,yoyo:true,repeat:5,repeatDelay:1.5},"in_2");
		return s3tl;
}
...
var slide_3_AniScene = new ScrollMagic.Scene({triggerElement: '.s3_header', 	triggerHook: 0.8})

//.addIndicators({ name:'slide_3_AniScene',	indent:400,	colorTrigger:'pink',	colorStart: 'red',colorEnd: 'green'})

.on('start', function() { 	s3_master.play(0)})
.on('leave', function() { 	s3_master.startTime(0); s3_master.kill()})
.addTo(controller);
...
var s4_svg_chart = document.getElementById("s4chart");
		...
		var s4tl = new TimelineMax();
			  s4tl.staggerFrom([c01,c02,c03,c04], 1.5, { y:"-=390", ease:Expo.easeInOut}, 0.5,"-=0.05");
				s4tl.staggerFrom([b01,b02,b03,b04], 1.8, { y:"+=700", transformOrigin:"50% 50%", ease:Expo.easeInOut}, 0.5,"-=1.8");
				return s4tl;
	}
...
var slide_4_AniScene = new ScrollMagic.Scene({triggerElement: '.s4_header', 	triggerHook: 0.8})
//.addIndicators({ name:'slide_4_AniScene',	indent:400,	colorTrigger:'pink',	colorStart: 'red', colorEnd: 'green' })
.on('start', function() {  s4_master.play(0)})
.addTo(controller);
/* --------------------------_________________------------------------------*/
/* --------------------------Slide 5 Animation------------------------------*/
...
s5_tl.add("in")
		 .staggerFrom([s5_img1,s5_img2,s5_img3], 2.2, {alpha:0,scale:0, transformOrigin:"50% 50%", ease:Power2.easeInOut}, 0.5,"-=0.05")

var slide_5_AniScene = new ScrollMagic.Scene({triggerElement: '.s5_header', 	triggerHook: 0.8})
//.addIndicators({ name:'slide_5_AniScene',	indent:400,	colorTrigger:'pink',	colorStart: 'red',	colorEnd: 'green'})
.on('start', function() { s5_tl.play(0)})
.addTo(controller);
/* --------------------------_________________------------------------------*/
/* --------------------------Slide 6 Animation------------------------------*/
...
var s6tl = new TimelineMax();
		s6tl.staggerFrom([p01,m01,m02,m03], 1.8, { x:"-=500", ease:Power3.easeInOut}, 0.25)
...
var slide_6_AniScene = new ScrollMagic.Scene({triggerElement: '.s6_header', 	triggerHook: 0.8})
//.addIndicators({ name:'slide_6_AniScene',	indent:400,	colorTrigger:'pink',	colorStart: 'red',	colorEnd: 'green'})
.on('start', function() { s6_master.play(0)})
.addTo(controller);
/* --------------------------_________________------------------------------*/
/* --------------------------Slide 7 Animation------------------------------*/
...
var s7_svg_chart_2 = document.getElementById("s7chart_2");
		...
		s7tl_1.add("in")
				...
				.from(c1_2, 1.8, {alpha:0,scaleX:0, transformOrigin:"50% 50%", ease:Elastic.easeInOut},"-=0.9")
 				.staggerFrom([c1_3,c1_4], 1.8, { scaleY:0, transformOrigin:"50% bottom", ease:Elastic.easeInOut}, 0.25,"-=1.5")
				.staggerFrom([c1_5,c1_6,c1_7], 1.8, { y:"+=590", transformOrigin:"50% bottom", ease:Expo.easeInOut}, 0.8,"-=1.5")
	...
	s7tl_2.add("in")
			...
			.from(c2_2, 1.8, {alpha:0,scaleX:0, transformOrigin:"50% 50%", ease:Elastic.easeInOut},"-=0.9")
			.staggerFrom([c2_3,c2_4,c2_8], 1.8, { scaleY:0, transformOrigin:"50% bottom", ease:Elastic.easeInOut}, 0.25,"-=1.5")
			.staggerFrom([c2_5,c2_6,c2_7], 1.8, { y:"+=590", transformOrigin:"50% bottom", ease:Expo.easeInOut}, 0.8,"-=1.5")
...
var slide_7_AniScene = new ScrollMagic.Scene({triggerElement: '.s7_header', 	triggerHook: 0.8})
//.addIndicators({ name:'slide_7_AniScene', indent:400,	colorTrigger:'pink',	colorStart: 'red',	colorEnd: 'green' })
.on('start', function() { s7_master.play(0)})
.addTo(controller);
...
s8_index_tl.add("in")
s8_index_tl.staggerFrom([s8_svg_chart_1,s8_svg_chart_2,s8_svg_chart_3], 3.1, {scale:0.85, autoAlpha:0,transformOrigin: "50% 50%", ease:Elastic.easeOut}, 0.36)
						.staggerFrom([s8_svg_label_1,s8_svg_label_2,s8_svg_label_3], 2, { y:"+=50", autoAlpha:0,transformOrigin: "center", ease:Elastic.easeOut}, 0.16,"in+=0.51");
...
s8_tl.add("in")
		 .from(s8_img, 1.8, {autoAlpha:0,scale:0.98, transformOrigin:"50% bottom", ease:Expo.easeInOut})

var slide_8_AniScene = new ScrollMagic.Scene({triggerElement: '.s8_header', 	triggerHook: 0.8})
//.addIndicators({	name:'slide_8_AniScene',	indent:400,	colorTrigger:'pink',	colorStart: 'red',	colorEnd: 'green'})
.on('start', function() { s8_tl.play(0); epra_tl.restart();})
.addTo(controller);
...
ep_tl.addEventListener("load",function(){
...
var myArray=[circle_1,circle_2,circle_3,circle_3_1,circle_4,circle_4_1,circle_5,circle_5_1,circle_6,circle_6_line,circle_6_1,circle_6_2,circle_6_3,circle_6_4,circle_6_5,circle_7]
var myArray_6=[circle_6_line,circle_6_1,circle_6_2,circle_6_3,circle_6_4,circle_6_5]
var myArraySmall=[circle_8,circle_8_1,circle_8_2]
var myArrayEnd=[circle_9,circle_10]

var myArray_tip=[circle_6_tp_1,circle_6_tp_2,circle_6_tp_3,circle_6_tp_4,circle_6_tp_5]
var myArray_6_over=[circle_6_1,circle_6_2,circle_6_3,circle_6_4,circle_6_5]


var masterArray=[line,circle_1,circle_2,path_1,circle_3,circle_3_1,path_2,circle_4,path_3,circle_4_1,circle_5,circle_5_1,path_4,circle_6,circle_6_line,circle_6_1,circle_6_2,circle_6_3,circle_6_4,circle_6_5,path_5,circle_7,path_6,circle_8,circle_8_1,circle_8_2,path_7,circle_9,circle_10]


var myArrayPath_1=[path_1,path_2,path_3,path_4,path_5,path_6,path_7]
...
epra_tl = new TimelineMax({ paused: false,delay:0.5});
  epra_tl.to(ep_tl, 0.2, {autoAlpha:1})
	...
	epra_tl.staggerFrom(masterArray, 0.8, {scale:0.75, autoAlpha:0,transformOrigin: "center", ease:Power3.easeInOut}, 0.36)
...
myArray_6_over[0].addEventListener("mouseover",function(e){ TweenMax.to($(this), 0.2, { transformOrigin:"50% 50%",scale:1.12});TweenMax.to(circle_6_tp_1, 0.2, {autoAlpha:1}); }, false);
myArray_6_over[0].addEventListener("mouseout",function(e){ TweenMax.to($(this), 0.2, {transformOrigin:"50% 50%",scale:1});TweenMax.to(circle_6_tp_1, 0.2, {autoAlpha:0}); }, false);

myArray_6_over[1].addEventListener("mouseover",function(e){ TweenMax.to($(this), 0.2, {transformOrigin:"50% 50%",scale:1.12});TweenMax.to(circle_6_tp_2, 0.2, {autoAlpha:1}); }, false);
myArray_6_over[1].addEventListener("mouseout",function(e){ TweenMax.to($(this), 0.2, {transformOrigin:"50% 50%",scale:1});TweenMax.to(circle_6_tp_2, 0.2, {autoAlpha:0}); }, false);

myArray_6_over[2].addEventListener("mouseover",function(e){ TweenMax.to($(this), 0.2, {transformOrigin:"50% 50%",scale:1.12});TweenMax.to(circle_6_tp_3, 0.2, {autoAlpha:1}); }, false);
myArray_6_over[2].addEventListener("mouseout",function(e){ TweenMax.to($(this), 0.2, {transformOrigin:"50% 50%",scale:1});TweenMax.to(circle_6_tp_3, 0.2, {autoAlpha:0}); }, false);

myArray_6_over[3].addEventListener("mouseover",function(e){ TweenMax.to($(this), 0.2, {transformOrigin:"50% 50%",scale:1.12});TweenMax.to(circle_6_tp_4, 0.2, {autoAlpha:1}); }, false);
myArray_6_over[3].addEventListener("mouseout",function(e){ TweenMax.to($(this), 0.2, {transformOrigin:"50% 50%",scale:1});TweenMax.to(circle_6_tp_4, 0.2, {autoAlpha:0}); }, false);

myArray_6_over[4].addEventListener("mouseover",function(e){ TweenMax.to($(this), 0.2, {transformOrigin:"50% 50%",scale:1.12});TweenMax.to(circle_6_tp_5, 0.2, {autoAlpha:1}); }, false);
myArray_6_over[4].addEventListener("mouseout",function(e){ TweenMax.to($(this), 0.2, {transformOrigin:"50% 50%",scale:1});TweenMax.to(circle_6_tp_5, 0.2, {autoAlpha:0}); }, false);

var s8_img_out = document.getElementById("s8_mainImg")

document.getElementById('defaultOpen_8').addEventListener('click', function() {
...
var s3_c2_svg_obj = document.getElementById("s3_content2");
	...
	s3_c2_svg_obj.addEventListener("load",function(){
...
s3_c3_svg_obj.addEventListener("load",function(){
...
var s3_c3tl = new TimelineMax({paused:false});
  	TweenMax.set(s3_3_div, { autoAlpha:1});
		...
		s3_c3tl.add("in_1")
			.staggerFrom([ic_b1_text,ic_b2_text,ic_b3_text], 2.5, {autoAlpha:0, y:"+=400", ease:Expo.easeInOut}, 0.5)
			.staggerFrom([ic_b1,ic_b2,ic_b3], 2.5, {autoAlpha:0, y:590, ease:Expo.easeInOut}, 0.5,"-=3.55");
